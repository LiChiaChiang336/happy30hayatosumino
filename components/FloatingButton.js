    ...
    <>
      ...
      >
        <div className="relative w-20 h-20 lg:w-28 lg:h-28">
          ...
          <div className="absolute inset-0 w-full h-full transition-transform duration-300 group-hover:scale-110 group-hover:rotate-[25.06deg]">
            <svg
              viewBox="0 0 100 100"
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
          ...
          <span className="absolute inset-0 flex items-center justify-center text-sm lg:text-base">Write</span>
        </div>
      </button>
